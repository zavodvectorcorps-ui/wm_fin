...
- [x] **Бэкап наличных** — отдельный лист "Наличные" в Google Sheets с операциями из Telegram и импорта
- [x] **Сводка по счетам** — все Telegram сводки показывают балансы по каждому счёту отдельно
