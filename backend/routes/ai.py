...
== Топ-10 статей расходов (текущий месяц) ==
...
== Топ-8 статей расходов по каждому месяцу (последние 12 месяцев) ==
{chr(10).join(monthly_cat_lines) or '— нет данных —'}
...
- Топ-8 статей расходов по каждому месяцу за последние 12 месяцев
  (в системе категории расходов называются «Статьи»)
...
прибыли и статьях расходов за любые периоды последних 12 месяцев
(например: «как менялись расходы на маркетинг в январе и феврале?»,
«какие статьи выросли сильнее всего», «сравни структуру расходов Q1
этого и прошлого года»).

Всегда называй категории расходов «статьи» — это терминология компании.
